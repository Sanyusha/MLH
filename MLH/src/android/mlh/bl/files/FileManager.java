 ...
 * GetInstance static method receives Context, so the FileManager will always be 
...
public class FileManager {
	...
	/**
	 * Serializes the given Task, and writes it to a file.
	 * Basically, saves the Task obj as a file.
	 * @param task - Task
	 * @throws IOException
	 */
	...
	/**
	 * De-serializes Task from file to obj,
	 * given the Task's name. 
	 * @param taskName
	...
	/**
	 * Deletes the serialized Task - e.i. deletes file
	 * that holds serialized Task.
	 ...
	 * @param taskName
	 * @return on success - path to the file which holds serialized Task,
	 * or 'PATH NOT FOUND' on failure
	 */
	...
	/**
	 * Returns reference to the FileManager.
